...
public interface ProvideConstants {
    ...
    String PROCESS_NAME_FULL_EXECUTE_PROVIDE_EYEMATICS_PROCESS =  /*EyeMaticsConstants.PROCESS_MII_NAME_BASE*/ "dsfdev_" + PROCESS_NAME_EXECUTE_PROVIDE_EYEMATICS_PROCESS;
