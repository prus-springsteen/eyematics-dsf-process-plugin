...
public interface ReceiveConstants {
    ...
    String PROCESS_NAME_FULL_EXECUTE_RECEIVE_EYEMATICS_PROCESS =  /*EyeMaticsConstants.PROCESS_MII_NAME_BASE*/ "eyematicsorg_" + PROCESS_NAME_EXECUTE_RECEIVE_EYEMATICS_PROCESS;
