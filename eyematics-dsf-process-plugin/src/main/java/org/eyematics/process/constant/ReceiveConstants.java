...
public interface ReceiveConstants {
    ...
    String PROFILE_TASK_INITIATE_EYEMATICS_RECEIVE_PROCESS = "https://eyematics.org/fhir/StructureDefinition/eyematics-receive-process-initiate-structure-definition";
    ...
    String BPMN_RECEIVE_EXECUTION_VARIABLE_DATA_SET_REFERENCE_BUNDLE = "dataSetReferenceBundle";
