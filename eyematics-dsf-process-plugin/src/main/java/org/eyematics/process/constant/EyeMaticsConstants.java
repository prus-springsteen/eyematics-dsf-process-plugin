...
public interface EyeMaticsConstants {
	...
	String NAMINGSYSTEM_DSF_TARGET_ORGANIZATION_IDENTIFIER = "http://dsf.dev/sid/organization-identifier";
	String NAMINGSYSTEM_DSF_TARGET_CORRELATION_KEY = "Correlation-Key";
