...
public class ActivityDefinitionProfileTest {
	...
	public static final ValidationSupportRule validationRule = new ValidationSupportRule(
			EyeMaticsProcessPluginDefinition.VERSION, EyeMaticsProcessPluginDefinition.RELEASE_DATE,
	...
	@Test
	public void testDataInitiateValid() throws Exception {
		ActivityDefinition ad = validationRule
				.readActivityDefinition(Paths.get("src/main/resources/fhir/ActivityDefinition/eyematics-initiate-process-activity-definition.xml"));
	...
	@Test
	public void testDataProvideValid() throws Exception {
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/eyematics-provide-process-activity-definition.xml"));
	...
	public void testDataReceiveValid() throws Exception {
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/eyematics-receive-process-activity-definition.xml"));
